...
const Hero = () => {
  const words = ['Front-End', 'Next.js', 'React.js'];
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative mt-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase text-xs tracking-widest max-w-80 text-center text-blue-100">
          ...
          />
          <div className="text-center md:tracking-wider text-sm mb-4 md:text-lg lg:text-2xl">
            Hi, i&apos;m Mohamed Tarek , a <FlipWords words={words} /> Developer
            Based In Egypt.
          </div>
          {/* Magic Button */}
          <a href="#about">
